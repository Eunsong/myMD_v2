...
public class Bond{
    ...
    public Bond(int i, int j, int func) {
    ...
    public Bond(int i, int j, int func, double b0, double k0) {
        this.atoms = new int[2];
        this.atoms[0] = i;
        this.atoms[1] = j;
        this.func = func;
    ...
    public static double energyType1(MdVector box, double b0, double k0, MdVector ri, MdVector rj) {

        MdVector rjImage = MdForce.minImage(box, ri, rj);
        double rij = MdVector.sub( ri, rjImage).norm();
    ...
    public static MdVector forceType1(MdVector box, double b0, double k0, MdVector ri, MdVector rj) {

        MdVector rjImage = MdForce.minImage(box, ri, rj);
        MdVector rij = MdVector.sub( ri, rjImage);
        double r = rij.norm();
