...
public class Dihedral{
    ...
    public Dihedral(int i, int j, int k, int l, int func) {
    ...
    public Dihedral(int i, int j, int k, int l, int func, double p0, double k0, int n) {
        this.atoms = new int[4];
        this.atoms[0] = i;
        this.atoms[1] = j;
        this.atoms[2] = k;
    ...
    public Dihedral(int i, int j, int k, int l, int func, double[] C) {
        this.atoms = new int[4];
        this.atoms[0] = i;
        this.atoms[1] = j;
        this.atoms[2] = k;
