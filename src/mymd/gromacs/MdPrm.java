...
//  private int nstfout; 
    ...
    public MdPrm() {
        // default PME and LJ setup 
        this.pme = true;
        this.Lennard_Jones = true;
    ...
    public void setCoulombType(String type){
        this.coulombType = type;
    }
    public String getCoulombType(){
        return this.coulombType;
    }
    ...
    public void setLennard_Jones(boolean bool){
        this.Lennard_Jones = bool;
    }

    public boolean PME_enabled(){
        return this.pme;
    }
    public boolean LJ_enabled(){
        return this.Lennard_Jones;
    }
