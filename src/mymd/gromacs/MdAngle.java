...
// File name : MdAngle.java
// Author : Eunsong Choi (eunsong.choi@gmail.com)
// Last updated : 2013-11-08
// description : A class that contains necessary information to compute angle potential 

public class MdAngle{
    ...
    public MdAngle(int i, int j, int k, int func) {
    ...
    public MdAngle(int i, int j, int k, int func, double t0, double k0) {
        this.atoms = new int[3];
        this.atoms[0] = i;
        this.atoms[1] = j;
        this.atoms[2] = k;
